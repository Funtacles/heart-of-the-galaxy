...
//			}
	...
	CREAMPIE_VAGINA(
			...
			Util.newArrayListOfValues(
					"<b style='color: " + Colour.ATTRIBUTE_ARCANE.toWebHexString() + "'>Dirties clothing</b>")) {
