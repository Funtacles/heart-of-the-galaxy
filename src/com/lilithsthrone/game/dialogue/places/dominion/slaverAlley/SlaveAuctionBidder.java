...
public class SlaveAuctionBidder {
	...
	public static SlaveAuctionBidder generateNewSlaveAuctionBidder(NPC slave) {
		...
		Subspecies[] races = new Subspecies[] {Subspecies.CAT_MORPH, Subspecies.COW_MORPH, Subspecies.DOG_MORPH, Subspecies.HORSE_MORPH, Subspecies.HUMAN, Subspecies.SQUIRREL_MORPH, Subspecies.WOLF_MORPH};
