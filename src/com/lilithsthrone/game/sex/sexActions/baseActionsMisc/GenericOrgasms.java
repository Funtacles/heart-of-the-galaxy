...
public class GenericOrgasms {
	...
	private static boolean isRealPenisFuckingCharacter(GameCharacter character, GameCharacter penetrator) {
		return (Sex.getCharactersUsingSexAreaOnCharacter(character, SexAreaPenetration.PENIS).contains(penetrator) && penetrator.hasPenis());
	}
	...
	private static String getPositionPreparation(GameCharacter characterOrgasming) {
		...
		switch(Sex.getSexPositionSlot(characterOrgasming)) {
			...
			case HAND_SEX_DOM_ROSE: case HAND_SEX_SUB_ROSE:
				...
				break;
			case KNEELING_PERFORMING_ORAL: case KNEELING_PERFORMING_ORAL_RALPH: case CHAIR_KNEELING:
				...
				break;
			case KNEELING_RECEIVING_ORAL: case KNEELING_RECEIVING_ORAL_RALPH: case CHAIR_ORAL_SITTING:
	...
	private static String getGenericVaginaOrgasmDescription(GameCharacter characterOrgasming, OrgasmCumTarget targetArea) {
		...
		if(targetArea == OrgasmCumTarget.LILAYA_PANTIES && !Main.game.getPlayer().hasPenis()) {
	...
	public static final SexAction PARTNER_GENERIC_ORGASM_CREAMPIE = new SexAction(
		...
		@Override
		public SexActionPriority getPriority() {
			if((Sex.getAllContactingSexAreas(Sex.getCharacterPerformingAction(), SexAreaPenetration.PENIS).get(0)==SexAreaOrifice.VAGINA && Sex.getCharacterPerformingAction().hasFetish(Fetish.FETISH_IMPREGNATION))) {
